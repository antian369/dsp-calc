...
class MixedConveyerBeltBuleprint {
  ...
  constructor(
    ...
    const produceMap = produceUnits
      .filter((unit) => unit.grossOutput > 0)
      .reduce(
        (a, b) => a.set(++b.recipe, b), // 这里的 recipe 是下标，比ID少1
        new Map()
      );
    ...
    if (this.proliferatorLevel > 1) { // todo: 还需加入喷涂类型，未传入
      // 喷涂
      stationItems.push({
